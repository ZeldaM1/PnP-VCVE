...
def parse_args():
    ...
    parser.add_argument('--exp_name', default=None, type=str, help='flexible name for me to distinguish')
...
def main():
    ...
    if args.exp_name is not None:
        ...
        cfg.work_dir=cfg.work_dir.replace(cfg.work_dir.split('/')[-1],args.exp_name)
    ...
    # datasets = SRREDSMultipleGTCompressDataset(cfg.data.train)
