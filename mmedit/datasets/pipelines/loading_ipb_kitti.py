...
class LoadImageFromFileList_Mix_Compress_ipb_kitti(LoadImageFromFile):
    ...
    def __call__(self, results):
        ...
        for filepath in filepaths:
            ...
            if self.load_qp_slice and self.key=='lq':
                ...
                crf, dirname, filename = filepath_split[2].split('_')[1], filepath_split[0].split('_')[0], filepath_split[0].split('_')[1].split('.')[0]
                ...
                if 'crf' in crf:
                    ...
                    qp=0.0
                    slice = 'I' if filename=='10' else 'P'
                # print('####################3', filepath, crf, dirname, filename)
            ...
            if self.load_mv and self.key=='lq':
                ...
                path_before = filepath.split('/png/')[0]
                filepath_mv= f'{path_before}/mv/{dirname}/{filename:08d}.npy'
