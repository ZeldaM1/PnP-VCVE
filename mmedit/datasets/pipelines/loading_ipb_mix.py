...
class LoadImageFromFileList_Mix_Compress_ipb_mixdataset(LoadImageFromFile):
    def __init__(self, qp_slice_file={'LR':'/data/zenghuimin/reds/train/LR/mv_REDS_train_QP_slice_v3.json'}, dataset_ratio=[0.25,0.5,0.75,1], data_ratio=[0.25,0.5,0.75,1],**kwargs):
        super().__init__(**kwargs)
        self.qp_slice_file=qp_slice_file
